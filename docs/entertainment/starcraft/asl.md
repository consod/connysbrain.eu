...
!!! warning "Spoiler Alert"
    ...
    Be prepared that the playlist shows the finals and the player names in the final first so it might spoil if you intend to watch from the Round of 24 :face_with_peeking_eye:
