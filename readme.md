...
With basic markdown syntax, write the images like this:
![Brain](https://ik.imagekit.io/vu0zmaqce/brain_1.jpg?tr=w-640,q-80)
...
- Adds srcset with multiple sizes for responsive loading
- Adds sizes, loading="lazy" attributes
- Wraps images in lightGallery links with proper data-lg-size and data-sub-html attributes
- Preserves your captions, displaying them in the lightbox overlay
